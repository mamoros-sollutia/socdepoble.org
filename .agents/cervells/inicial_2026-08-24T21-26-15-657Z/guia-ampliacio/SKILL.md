...
status: active
version: 1.0.0
triggers_ca: ["afegir funcionalitat", "nova feature", "ampliar arquitectura", "crear skill", "com afegir"]
---
...
## 1. Respectar l'Offline-First (Actualment Online-First amb Sollutia)
Qualsevol component o mòdul ha d'estar pensat perquè en el futur puga funcionar 100% en local. Tota persistència ha de passar per `src/data/outbox.js` i `src/data/sincronitzador.js`, evitant crides directes a Supabase des dels components React si impliquen mutacions asíncrones bloquejants.
