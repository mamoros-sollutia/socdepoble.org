...
estat: generat
tipus: document
description: Vista generada des de .agents/skills/obsidian-markdown/SKILL.md; no editar.
source: .agents/skills/obsidian-markdown/SKILL.md
source_sha256: ee4ff9dbf79b5179f47baaac6173a064ffa5f6ca7f40f82e1e4742c08f4bc43a
---

> [!warning] FITXER GENERAT
> Font canònica: `.agents/skills/obsidian-markdown/SKILL.md`. Qualsevol edició manual serà sobreescrita.
