...
## El Consell
Açò és l'equip complet (les "ties" electròniques):

- [Z.ai](https://z.ai/)
- [Qwen](https://chat.qwenlm.ai/)
- [Deepseek](https://chat.deepseek.com/)
- [Dola](https://dola.com/chat/)
...
*Regla Sagrada:* Sempre s'han d'enumerar totes sense excepció quan parlem del Consell.
