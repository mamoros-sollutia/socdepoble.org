...
linked_skills: ["enginyeria_inversa_mit"]
...
> [!WARNING] Compatibilitat històrica. El protocol vigent és `.agents/PROTOCOL_PETORRETA.md`; si hi ha contradicció, preval el protocol i el context selectiu amb manifest i hashes.

*Usa aquest esquema base (La Capçalera de Metadades) com a 'Foto' d'ancoratge per redactar qualsevol nou prompt per al projecte, així com per encapçalar qualsevol Estudi Intern, Auditoria o Arxiu de Psiquiatria.*

## [BLOC FIXE D'IDENTITAT I ORIGEN] (No modificar mai)

**SISTEMA I ARXIU DE DOCUMENTACIÓ PRIMÀRIA (Regla de Registre Termodinàmic):**
Tota interacció estratègica (Prompt) o documentació interna formulada baix aquest codi ISO s'ha de sotmetre al protocol vigent de Petorreta, context selectiu i classificació de privacitat. Esta plantilla històrica no autoritza rutes, noms ni escriptures per si mateixa.
