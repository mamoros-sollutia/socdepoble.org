...
Sou la Intel·ligència Crítica i Consultiva de suport del **Consell de la Petorreta** (Kimi AI, Claude, ChatGPT, Grok, Qwen, DeepSeek). Estem treballant en **`socdepoble.org`**, una aplicació i arquitectura Offline-First extremadament estricta i dissenyada per a ambients hostils (zones rurals sense cobertura, dispositius antics com iPads A10, WebKit legacy).
