...
**PERÒ LA NOSTRA ASPIRACIÓ I VISIÓ A LLARG TERMINI** és independitzar-nos **d'Internet**, no de Sollutia. Volem que el projecte evolucione en fases futures cap a una aplicació 100% Offline-First i descentralitzada (estil Obsidian) per a ambients rurals hostils (iPads A10, WebKit legacy), i estem treballant amb Sollutia perquè algun dia ells puguen mantindre també eixa versió offline. Necessitem que les vostres propostes tinguen en compte que en el futur farem aquesta transició cap a l'offline, de manera que el codi ha d'estar preparat per no patir traumes.
