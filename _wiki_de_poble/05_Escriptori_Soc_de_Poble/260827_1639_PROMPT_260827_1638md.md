...
**MOLT IMPORTANT (LA VERITAT ARQUITECTÒNICA):** No som encara una aplicació Offline-First pura. Actualment vivim incrustats absolutament dins del sistema de la nostra empresa sòcia, **Sollutia**. Ens hi hem d'endollar pacíficament perquè ells puguen mantindre'l sense problemes. La nostra memòria cau local és només "tèrmica" temporalment i depenem de Supabase com a font de dades en línia.
**PERÒ LA NOSTRA ASPIRACIÓ I VISIÓ A LLARG TERMINI** és esdevenir una aplicació 100% Offline-First i descentralitzada, dissenyada per a ambients hostils (sense cobertura rural, iPads A10, WebKit legacy). Busquem la màxima independència entre Frontend i Backend. Necessitem que les vostres propostes tinguen en compte que en el futur farem aquesta transició cap a l'autonomia (tallant el cordó umbilical amb Sollutia), de manera que el codi ha d'estar preparat per no patir traumes.
