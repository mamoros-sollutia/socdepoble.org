...
**MOLT IMPORTANT (LA VERITAT ARQUITECTÒNICA):** No som encara una aplicació Offline-First pura. Actualment vivim incrustats absolutament com un component dins d'un plugin de WordPress de l'agència Sollutia. La nostra memòria cau local és només "tèrmica" temporalment i depenem de Supabase com a font de dades en línia.
**PERÒ LA NOSTRA ASPIRACIÓ I VISIÓ A LLARG TERMINI** és esdevenir una aplicació 100% Offline-First i descentralitzada, dissenyada per a ambients hostils (sense cobertura rural, iPads A10, WebKit legacy). Necessitem que les vostres propostes tinguen en compte que en el futur farem aquesta transició, de manera que ens proporcioneu el codi adequat per a que això passe sense traumes. Més tard o d'hora tallarem el cordó umbilical.
