...
- **Límits de temps i ús:**
  - Límit de 5 hores: 52% restant.
  - Límit setmanal: 61% restant.
- **Estratègia Astra Lleuger vs. Sol Màxim:**
  - Actualment ens queda, aproximadament, **una iteració forta** usant la versió "Astra lleuger".
  - Si esgotem aquesta via o necessitem més potència de raonament per a la Fase 6, haurem de baixar a **"Sol màxim"**. 
  - Com a part d'aquesta estratègia, quan rebaem dictàmens de "Sol màxim" en les pròximes iteracions, **compararé els resultats amb els d'Astra** per aconsellar-te quin ens ofereix millor rendiment (Cost Termodinàmic vs. Índex de Trellat).
