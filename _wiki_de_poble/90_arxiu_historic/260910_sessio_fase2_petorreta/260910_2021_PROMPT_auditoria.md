...
Auditar l'estat actual de la Fase 2 i dissenyar un **Pla d'Acció de Neteja Extrema**.

`OBJECTIU: Auditar el paquet i crear un pla de xoc per eliminar TOT el codi fantasma, divs inútils, estils orfes i resoldre els 234 warnings d'ESLint.`

Necessitem que el Consell ens ajude amb:
1. **La desconstrucció d'UniversalElements.jsx**: (794 línies de monstre). Com el fragmentem sense trencar mig projecte?
2. **ESLint**: Hi ha 234 warnings per variables no utilitzades (majoritàriament a `/tooling/wiki/`). Volem una estratègia ràpida per netejar-ho sense trencar els scripts.
3. **Poda absoluta**: Qualsevol div, classe CSS o fitxer que no siga estrictament necessari ha de ser marcat per a l'eliminació. Volem el sistema impol·lut.

## Context Necessari

Bundle aparellat: 260910_2021_BUNDLE_auditoria.md.
