...
12. **ChatGPT (OpenAI)** — segona opinió general, estructuració, traduccions.

No se'n pot ometre cap. No se'n pot inventar cap. Respectar les característiques úniques de cadascuna.
...
3. Documents canònics de `00_SER_Brain_Identitat` (especialment `02_EQUIP_IA.md` com a referència llarga)
4. Gates i tractores (`tractor-cognitiu`, design_guard, etc.)
