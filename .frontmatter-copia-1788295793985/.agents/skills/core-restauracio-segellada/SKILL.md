...
lang: ca
core: true
triggers_on: ["restaura", "restaurar", "còpia de seguretat", "copia de seguretat", "backup", "torna arrere", "tornar arrere", "revertir", "revert", "rollback", "checkout", "restore", "recupera la versió", "recuperar versió", "com estava abans", "git checkout", "git reset", "git revert"]
---
