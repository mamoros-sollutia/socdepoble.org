...
{/*  ESQUERRA: tornar arrere, endavant, índex  */}
<div className="bar-blue-left sdp-flex sdp-items-center sdp-gap-24">
<button className="sp-card-action" title="Tornar arrere" onClick={() => navigate(-1)}>
<svg className="icon" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="m12 19-7-7 7-7" /><path d="M19 12H5" /></svg>
</button>
<button className="sp-card-action" title="Endavant">
<svg className="icon" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="m12 5 7 7-7 7" /><path d="M5 12h14" /></svg>
</button>
<button className="sp-card-action" title="Índex de secció" onClick={() => setIsTocOpen(true)}>
<svg className="icon" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" /></svg>
</button>
</div>
{/*  CENTRE: Traduir, IAIA, Compartir  */}
...
<button className="sp-card-action" title="IAIA MarIA">
            <IaiaIcon />
</button>
...
{/*  DRETA: Connectar  */}
<button className="sp-card-connect" onClick={() => navigate('/connectar')}>Connectar</button>
</header>
{/*  IMATGE HERO (Entre Blava i Taronja)  */}
<div className="hero-image">
<img alt="Construcció de Pedra Seca estil Ibáñez" src="assets/img/ibanez_pedra_seca_design_1780873465211.png"/>
</div>
{/*  4. BARRA TARONJA  */}
<section className="bar-orange">
...
<span>23:33</span><span>22/3/26</span>
</button>
</div>
</section>
...
{/*  Logotip Mode Fosc  */}
<img alt="Logotip Sóc de Poble" className="page-title-logo dark-only" src="https://socdepoble.org/assets/system/ui/logo-socdepoble-rect-blanc.svg"/>
...
<div className="sp-card-copyright page-title-copyright">© Sóc de Poble / Fet per la IAIA i Nano Banana</div>
</header>
<div className="sdp-text-center sdp-mb-6" style={{ padding: '0 var(--sdp-pad-contenidor)' }}>
<h2>Sistema oficial de disseny per a Sóc de Poble</h2>
<p className="lead">Inclou la Targeta Mestra, els colors oficials, i tots els elements preparats, inclús els skills i scripts, perquè qualsevol IA puga entendre este sistema i reproduir-lo.</p>
</div>
...
<div className="swatch">
<div className="swatch-color sw-primary-700">Taronja · text</div>
<div className="swatch-info">#ad4c03<br/>--sdp-primary-700</div>
</div>
<div className="swatch">
...
<div className="swatch">
<div className="swatch-color sw-secondary-600">Blau · text</div>
...
<tr><td>Blanc sobre blau 500</td><td>5.27:1</td><td>AA</td><td>Barra blava, peu de targeta</td></tr>
...
<div className="sdp-text-center" style={{ padding: '0 var(--sdp-pad-contenidor)' }}>
...
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-1)'}}></div>
<div className="spacing-label">--sdp-space-1 = 4px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-2)'}}></div>
<div className="spacing-label">--sdp-space-2 = 8px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-3)'}}></div>
<div className="spacing-label">--sdp-space-3 = 12px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-4)'}}></div>
<div className="spacing-label">--sdp-space-4 = 16px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-6)'}}></div>
<div className="spacing-label">--sdp-space-6 = 24px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-8)'}}></div>
<div className="spacing-label">--sdp-space-8 = 32px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-10)'}}></div>
<div className="spacing-label">--sdp-space-10 = 40px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-12)'}}></div>
<div className="spacing-label">--sdp-space-12 = 48px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-16)'}}></div>
<div className="spacing-label">--sdp-space-16 = 64px</div>
</div>
<div className="spacing-item">
<div className="spacing-bar" style={{'--mida': 'var(--sdp-space-20)'}}></div>
...
<svg className="spinner" viewBox="0 0 24 24"><circle cx="12" cy="12" fill="none" r="10" stroke="currentColor" strokeWidth="3" /></svg>
            Carregant...
          </button>
</div>
<h4>Amb Icona</h4>
<div className="btn-group">
<button className="btn btn-primary">
<svg className="icon-btn" viewBox="0 0 24 24"><path d="M12 5v14M5 12h14" /></svg> Afegir
          </button>
<button className="btn btn-secondary">
<svg className="icon-btn" viewBox="0 0 24 24"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg> Eliminar
          </button>
</div>
</section>
{/*  SECCIÓ: FORMULARIS  */}
...
{/*  SECCIÓ 7: ALERTES  */}
<section className="design-block">
<h3>6. Alertes i Missatges</h3>
<div className="alert alert-info">
<div className="alert-icon"><svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" y1="16" y2="12" /><line x1="12" x2="12.01" y1="8" y2="8" /></svg></div>
...
<div className="alert-icon"><svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01"></polyline></svg></div>
<div className="alert-content">
<h4>Èxit</h4>
...
<div className="alert-icon"><svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" /><line x1="12" x2="12" y1="9" y2="13" /><line x1="12" x2="12.01" y1="17" y2="17" /></svg></div>
<div className="alert-content">
<h4>Avís</h4>
...
<div className="alert-icon"><svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><line x1="15" x2="9" y1="9" y2="15" /><line x1="9" x2="15" y1="9" y2="15" /></svg></div>
<div className="alert-content">
<h4>Error</h4>
...
<span className="badge badge-outline"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> Poble actiu</span>
<span className="badge badge-outline"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" /><circle cx="12" cy="13" r="4" /></svg> Fototeca</span>
<span className="badge badge-outline"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8"></polyline><line x1="16" x2="8" y1="13" y2="13" /><line x1="16" x2="8" y1="17" y2="17" /><polyline points="10 9 9 9 8 9"></polyline></svg> Arxiu</span>
...
<span className="badge badge-outline"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" y1="16" y2="12" /><line x1="12" x2="12.01" y1="8" y2="8" /></svg> Festes</span>
</div>
</section>
{/*  SECCIÓ 9: TAULES  */}
<section className="design-block">
...
{/*  SECCIÓ 12: CÀRREGA  */}
<section className="design-block">
<h3>11. Indicadors de Càrrega</h3>
<div className="spinner-group">
<div className="sdp-text-center"><svg className="spinner spinner-sm" viewBox="0 0 24 24"><circle cx="12" cy="12" fill="none" r="10" stroke="currentColor" strokeWidth="3" /></svg>
Petit</div>
<div className="sdp-text-center"><svg className="spinner spinner-md" viewBox="0 0 24 24"><circle cx="12" cy="12" fill="none" r="10" stroke="currentColor" strokeWidth="3" /></svg>
Normal</div>
<div className="sdp-text-center"><svg className="spinner spinner-lg" viewBox="0 0 24 24"><circle cx="12" cy="12" fill="none" r="10" stroke="currentColor" strokeWidth="3" /></svg>
Gran</div>
</div>
...
<h3>18. Divisors i Separadors</h3>
...
{/*  SECCIÓ 24: TARGETES MESTRES  */}
<section className="design-block">
<h3>19. Targeta Mestra (Sóc de Poble Universal Card)</h3>
<p className="sdp-text-center sdp-mb-2">La Targeta Mestra és un bloc modular desmuntable i enllaçable (amb <code>&lt;a className="sp-card-link-overlay"&gt;</code>). Qualsevol clic dins d'ella condueix a la pàgina, excepte els botons amb funcions específiques (z-index superior).</p>
<h4>19.1 Targeta Mestra: Text pur i Etiquetes (Gestoria de Poble)</h4>
<article className="sp-card">
{/*  Enllaç fantasma que recobreix tota la targeta  */}
<a className="sp-card-link-overlay" href="#" title="Obrir Caixa Real"></a>
<header className="sp-card-header">
<a className="sp-card-author-link" href="#targeta-perfil" title="Anar al perfil de l'autor">
<div className="sp-card-author">
<img alt="Avatar" className="sp-card-avatar sdp-p-0" src="https://socdepoble.org/assets/system/ui/logo-socdepoble-cuadrat-verd.svg"/>
<div className="sp-card-author-info">
<div className="sp-card-author-name">Sóc de Poble</div>
...
<svg className="icon" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="m9 12 2 2 4-4" /></svg>
</button>
<div className="tooltip-text">Mode Privadesa actiu</div>
</div>
<button className="btn-date-time" title="Veure calendari d'este dia">
<span>14:32</span><span>30/06/26</span>
</button>
</div>
</header>
...
<h4>19.2 Targeta Mestra: Text pur (Hisenda)</h4>
<article className="sp-card">
{/*  Enllaç fantasma que recobreix tota la targeta  */}
<a className="sp-card-link-overlay" href="#" title="Obrir Hisenda"></a>
<header className="sp-card-header">
<a className="sp-card-author-link" href="#targeta-perfil" title="Anar al perfil de l'autor">
<div className="sp-card-author">
<img alt="Avatar" className="sp-card-avatar sdp-p-0" src="https://socdepoble.org/assets/system/ui/logo-socdepoble-cuadrat-verd.svg"/>
...
<svg className="icon" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24"><path d="m3 11 18-5v12L3 14v-3z" /><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6" /></svg>
</button>
...
<h4>19.3 Targeta Mestra: Imatge Completa (Producte)</h4>
<article className="sp-card">
{/*  Enllaç fantasma que recobreix tota la targeta  */}
...
<h4>19.4 Targetes Mestra (Totes les variants recuperades)</h4>
...
<article className="sp-card" id="targeta-perfil">
<a className="sp-card-link-overlay" href="#targeta-perfil" title="Obrir Perfil"></a>
...
<section className="design-block">
<h3>20. Estadístiques i Dashboards</h3>
<h4>20.1 Targeta d'estadística</h4>
<div className="stat-card sdp-mb-6">
<div className="stat-icon"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg></div>
<div className="stat-info">
<div className="stat-value">5.847</div>
<div className="stat-label">Habitants</div>
</div>
</div>
<h4>20.2 Grid d'estadístiques</h4>
<div className="stat-grid">
<div className="stat-card">
<div className="stat-icon"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><rect height="18" rx="2" ry="2" width="18" x="3" y="4" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></svg></div>
<div className="stat-info">
...
<div className="stat-card">
<div className="stat-icon"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22"></polyline></svg></div>
<div className="stat-info">
...
<div className="stat-info">
<div className="stat-value">33,4</div>
...
<h4>20.3 Panell d'Umami (Integració directa)</h4>
<div className="dashboard-panel">
<div className="dashboard-header"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><line x1="18" x2="18" y1="20" y2="10" /><line x1="12" x2="12" y1="20" y2="4" /><line x1="6" x2="6" y1="20" y2="14" /></svg> Activitat del Portal</div>
...
<div className="dashboard-item">
<div className="dashboard-item-value">33,4%</div>
...
<div className="search-result-excerpt">Del 15 al 24 d'agost celebrem les festes patronals amb més de 50 activitats per a tots els públics...</div>
</div>
<div className="search-result">
...
<span>...</span>
<a className="page-btn" href="#">24</a>
<a className="page-btn" href="#">Següent →</a>
</div>
<h4>22.2 Paginació simplificada (anterior / següent)</h4>
...
<section className="design-block">
<h3>23. Llistes de Tasques i Checklists</h3>
<h4>23.1 Checklist d'administració</h4>
<div className="checklist-admin">
<div className="checklist-item">
<input defaultChecked type="checkbox"/>
<label><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01"></polyline></svg> Verificació prèvia a publicar</label>
</div>
<div className="checklist-item">
<input defaultChecked type="checkbox"/>
...
<h4>23.2 Llista de tasques amb progrés</h4>
<div className="checklist-admin">
<div className="checklist-item">
<input defaultChecked type="checkbox"/>
...
<section className="design-block">
<h3>24. Upload i Descàrregues</h3>
<h4>24.1 Zona d'arrossegament d'arxius</h4>
...
<h4>24.2 Enllaç de descàrrega</h4>
<div className="download-card">
<div className="download-card-icon"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8"></polyline><line x1="16" x2="8" y1="13" y2="13" /><line x1="16" x2="8" y1="17" y2="17" /><polyline points="10 9 9 9 8 9"></polyline></svg></div>
...
<a className="download-card-btn" href="#"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><line x1="12" x2="12" y1="5" y2="19" /><polyline points="19 12 12 19 5 12"></polyline></svg></a>
</div>
</section>
{/*  SECCIÓ 30: EMBEDDINGS I MEDIA EXTERNA  */}
<section className="design-block">
<h3>25. Embeddings i Media Externa</h3>
<h4>25.1 Vídeo embebint (HTML5 natiu)</h4>
<div className="embed-container">
<div className="sdp-flex sdp-items-center sdp-justify-center">
<div className="sdp-flex sdp-items-center sdp-justify-center"><svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></div>
</div>
</div>
<div className="embed-caption">Sóc de Poble: Portal de pobles connectats (2013)</div>
<div className="accordion sdp-mb-6">
<div className="accordion-header">
<svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8"></polyline><line x1="16" x2="8" y1="13" y2="13" /><line x1="16" x2="8" y1="17" y2="17" /><polyline points="10 9 9 9 8 9"></polyline></svg> Descripció del vídeo original
            <svg fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="20"><polyline points="6 9 12 15 18 9"></polyline></svg>
</div>
</div>
<h4>25.2 Mapa embebint (iframe amb fallback)</h4>
...
<h4>25.3 Audio (podcast local)</h4>
<div className="audio-player">
<button className="audio-play-btn"><svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg></button>
...
<li><strong>.sdp-text-avis</strong> - <svg aria-hidden="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icona-linia" viewBox="0 0 24 24" width="16"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" /><line x1="12" x2="12" y1="9" y2="13" /><line x1="12" x2="12.01" y1="17" y2="17" /></svg> Avís</li>
