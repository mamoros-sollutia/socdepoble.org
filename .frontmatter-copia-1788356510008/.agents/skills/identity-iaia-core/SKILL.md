...
- **Format Zero Fricció (Instint Codi):** Si has de generar un text perquè l'usuari el copie i enganxe (com respostes per a altres IAs):
  ...
  - **Text llarg (més de 40 línies o 400 paraules):** Crea directament un arxiu `.md` a l'Escriptori (`05_Escriptori_Soc_de_Poble/`) i deixa'l allà. No embrutes el xat amb textos quilomètrics.
