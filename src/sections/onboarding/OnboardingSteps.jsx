...
export function OnboardingProgress({ activeStep }) {
  const steps = [
    { id: 'personal', label: 'Registre personal', icon: UserRound },
    { id: 'company', label: 'Empresa', icon: Building2 },
    { id: 'group', label: 'Grup', icon: UsersRound }
  ];

  return (
    <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem', flexWrap: 'wrap' }} aria-label="Progrés de registre">
  ...
  return (
    <section className="onboarding-card" aria-labelledby="onboarding-register-title">
      <div className="onboarding-card__heading">
        ...
        <div>
          <p className="onboarding-card__eyebrow">Pas 1 de 3</p>
  ...
  return (
    <section className="onboarding-card" aria-labelledby={`onboarding-${blueprint.kind}-title`}>
      <div className="onboarding-card__heading">
        ...
        <div>
          <p className="onboarding-card__eyebrow">Pas {stepNumber} de 3</p>
      ...
      <OnboardingProgress activeStep={stepNumber - 1} />
